    ...
    >
      <div className="flex justify-between items-center px-6 md:px-margin max-w-[1440px] mx-auto">
        <Link href="/" className="flex items-center gap-3 group">
          <Image loader={staticLoader} src="/vicometal/assets/vicometal_logo_final.png" alt="Grupo Vicometal" width={240} height={58} className="h-[56px] w-auto object-contain invert hue-rotate-180 opacity-90 group-hover:opacity-100 transition-opacity duration-300" />
        </Link>
